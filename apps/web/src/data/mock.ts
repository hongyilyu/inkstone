...
export const models: Model[] = [
	{
		...
		provider: "local",
		name: "gemma-3 27b",
		description: "Local sandbox model running through ollama. Fast, private, no quota.",
		tier: "$",
		capabilities: ["files"],
		favorite: true,
	},
	{
		...
		provider: "meta",
		name: "Llama 3.3 70B",
		description: "Meta's open-weight workhorse. Strong reasoning, broad tool use.",
		tier: "$",
	...
	},
	{
		...
		description: "Balanced Anthropic model. Great at code edits and long-context work.",
		tier: "$$",
	...
	},
	{
		...
		description: "Anthropic's flagship. Best for hard reasoning and architectural tasks.",
		tier: "$$$",
		capabilities: ["vision", "reasoning", "files"],
	},
	{
		...
		provider: "openai",
		name: "GPT-5",
		description: "OpenAI's general-purpose model. Solid across coding, writing, and search.",
		tier: "$$",
		capabilities: ["vision", "reasoning", "files"],
		favorite: true,
	},
	{
		...
		provider: "openai",
		name: "GPT-5.4 mini",
		description: "Smaller, cheaper OpenAI tier — quick replies, light reasoning.",
		tier: "$",
	...
	},
	{
		...
		provider: "google",
		name: "Gemini 2.5 Pro",
		description: "Google's long-context model. Multimodal with strong document handling.",
		tier: "$$",
		capabilities: ["vision", "reasoning", "files"],
	},
	{
	...
	},
	{
		...
		provider: "moonshot",
		name: "Kimi K2",
		description: "Moonshot's long-context model. Handles huge documents in one shot.",
		tier: "$$",
		capabilities: ["vision", "files"],
	},
];
