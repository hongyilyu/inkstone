...
const Parameters = Type.Object({
  path: Type.String({ description: "Absolute or vault-relative path to the file to write" }),
...
export const writeFileTool: AgentTool<typeof Parameters> = {
  name: "write_file",
  label: "Write File",
  description: "Write or append content to a file. Creates parent directories if needed. Path must be within the vault directory.",
