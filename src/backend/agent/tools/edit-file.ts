...
const Parameters = Type.Object({
  path: Type.String({ description: "Absolute or vault-relative path to the file to edit" }),
...
export const editFileTool: AgentTool<typeof Parameters> = {
  name: "edit_file",
  label: "Edit File",
  description: "Replace text in a file. Returns a unified diff. Path must be within the vault directory.",
